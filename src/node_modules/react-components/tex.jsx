"use strict";;
import _katexA11yJs from "./katex-a11y.js";
...
const loadMathJax = callback => callback();
...
const TeX = createReactClass({
    ...
    componentDidMount: function() {
        ...
        if (this.katexRef.current && this.katexRef.current.childElementCount > 0) {
        ...
        try {
            return {
                __html: katex.renderToString(
                    ...
                    {...props.katexOptions, minRuleThickness:0.06}
                ),
            };
        } catch (e) {
    ...
    setScriptText: function(text) {
        if (!this.script) {
            ...
            if (this.mathjaxRef.current) {
                this.mathjaxRef.current.appendChild(this.script);
            }
        }
